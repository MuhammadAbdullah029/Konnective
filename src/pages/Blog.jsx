...
const Blog = () => {
 ...
 const blogPosts = [
  ...
  },
  {
    ...
    excerpt: 'A step-by-step guide to boosting your search engine rankings with proven SEO strategies.',
    category: 'seo',
    author: 'Mike Johnson',
    date: '2024-01-12',
    readTime: '8 min read',
  ...
  },
  {
    ...
    excerpt: 'Learn how color choices impact user behavior and conversion rates on your website.',
    category: 'web-design',
    author: 'Emma Chen',
    date: '2024-01-10',
    readTime: '6 min read',
  ...
  },
  {
    ...
    excerpt: 'A detailed breakdown of our digital marketing strategy that tripled lead generation for a B2B client.',
  ...
  },
  {
    ...
    excerpt: 'Essential local SEO strategies to help your business rank higher in local search results.',
    category: 'seo',
    author: 'Mike Johnson',
    date: '2024-01-03',
    readTime: '9 min read',
        ...
        <div className="container-custom">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Digital Marketing <span className="gradient-text fn">Insights</span>
            </h1>
                  ...
                  <div className="h-64 lg:h-auto bg-gradient-to-br from-primary-100 to-primary-200 flex items-center justify-center">
                    <div className="text-center flex flex-col items-center justify-center gap-4">
                      <div className="w-20 h-20 scale-[1.5] bg-primary-300 rounded-full flex items-center justify-center mx-auto mb-4">
                        <img className='w-full h-full object-cover rounded-full' src="./roberto-cortese-ejhjSZKTeeg-unsplash (1) (1).jpg" alt="" />
                      </div>
                      <span className="text-[#146aff] font-semibold">Featured Article</span>
                    </div>
                  </div>
                ...
                <div className="h-48 bg-gradient-to-br from-primary-100 to-primary-200 flex items-center justify-center">
                  <div className="text-center flex flex-col items-center justify-center gap-4">
                    <div className="w-16 h-16 scale-[1.5] bg-primary-300 rounded-full flex items-center justify-center mx-auto mb-2">
                      <img loading="lazy" className="w-full h-full object-cover rounded-full" src={post.image} alt="" />
                    </div>
