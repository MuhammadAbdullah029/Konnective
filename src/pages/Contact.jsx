  ...
  const faqs = [
    {
      ...
      answer: 'We can typically start within 1-2 weeks of signing the contract, depending on the scope of work and our current capacity.'
    },
    {
    ...
    },
    {
      ...
      answer: 'We track key metrics that matter to your business: leads, conversions, revenue, and ROI. You\'ll receive regular reports showing your progress.'
    }
  ]
    ...
    >
                  ...
                  <form ref={formRef} onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="complete">Complete Digital Package</option>
                      </select>
                    </div>
      ...
      <section className="h-96 bg-gray-200 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">123 Business Ave, Suite 100<br />New York, XYZ</p>
        </div>
      </section>
    </motion.div>
  )
