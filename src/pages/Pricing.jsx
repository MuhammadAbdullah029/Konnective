        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Complete digital marketing solutions designed to grow your business. 
              From strategy to execution, we handle everything so you can focus on what you do best.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              All packages include our core services with varying levels of support.
            </p>
          </motion.div>
                ...
                <ul className="space-y-3 mb-8">
                  {pkg.features.map((feature) => (
                    <li key={feature} className="flex items-center">
                      <CheckCircle className="text-[#146aff] mr-3 flex-shrink-0" size={16} />
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We follow a proven process to ensure your digital marketing success
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              { step: '02', title: 'Strategy', description: 'We create a customized digital marketing strategy' },
              { step: '03', title: 'Execution', description: 'We implement and launch your campaigns' },
              { step: '04', title: 'Optimization', description: 'We monitor, analyze, and continuously improve results' }
            ].map((process, index) => (
              <motion.div
                key={process.step}
                initial={{ y: 20, opacity: 0 }}
