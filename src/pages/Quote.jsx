        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Thank you for your interest in our services. We'll review your requirements 
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Tell us about your business and goals, and we'll create a custom digital 
              marketing proposal tailored to your needs and budget.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              {currentStep === 1 && (
                ...
                >
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Tell Us About Your Business</h2>
              ...
              {currentStep === 4 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Tell Us About Your Goals</h2>
