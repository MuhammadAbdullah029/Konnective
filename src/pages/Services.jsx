...
useEffect(() => {
  if(location.hash) {
    ...
    if(service) {
      setTimeout(() => {
        const yOffset = -180;
        const y = service.getBoundingClientRect().top + window.pageYOffset + yOffset;
                      ...
                      <ul className="space-y-2">
                        {service.features.map((feature) => (
                          <li key={feature} className="flex items-center">
                            <CheckCircle className="text-[#146aff] mr-2 flex-shrink-0" size={16} />
                      ...
                      <ul className="space-y-2">
                        {service.benefits.map((benefit) => (
                          <li key={benefit} className="flex items-center">
                            <CheckCircle className="text-[#17c7fb] mr-2 flex-shrink-0" size={16} />
