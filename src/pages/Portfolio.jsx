...
const Portfolio = () => {
  ...
  const projects = [
  {
    ...
    testimonial: 'Konnective transformed our entire digital presence. We went from struggling to get leads to having more qualified prospects than we can handle.',
  ...
  },
  {
    ...
    category: 'social',
    image: './roberto-cortese-ejhjSZKTeeg-unsplash (1) (1).jpg',
    description: 'Social media marketing campaign for local restaurant expansion',
    ...
    testimonial: 'Our social media presence went from non-existent to industry-leading. Customer engagement has never been higher.',
  ...
  },
  {
    ...
    category: 'website',
    image: './roberto-cortese-ejhjSZKTeeg-unsplash (1) (1).jpg',
    description: 'Complete website redesign and optimization for online fashion retailer',
    services: ['Website Development', 'E-commerce Integration', 'UX/UI Design'],
    results: [
      { metric: 'Conversion Rate', value: '85%' },
      { metric: 'Page Load Speed', value: '60%' },
      { metric: 'Mobile Traffic', value: '200%' }
    ],
    testimonial: 'The new website not only looks amazing but also converts visitors into customers at an incredible rate.',
  ...
  },
  {
    ...
    services: ['SEO Optimization', 'Google Ads', 'Local SEO', 'Content Marketing'],
    results: [
      { metric: 'Search Rankings', value: 'Top 3' },
      { metric: 'Organic Traffic', value: '400%' },
      { metric: 'Qualified Leads', value: '250%' }
    ],
    testimonial: 'We now dominate local search results and get more qualified leads than ever before.',
  ...
  },
  {
    ...
    services: ['Website Development', 'SEO', 'Social Media', 'Online Reputation'],
    results: [
      { metric: 'New Patients', value: '200%' },
      { metric: 'Online Reviews', value: '4.9/5' },
      { metric: 'Appointment Bookings', value: '150%' }
    ],
    testimonial: 'Patient acquisition has never been easier. Our online presence now reflects the quality of care we provide.',
  ...
  },
  {
    ...
    testimonial: 'The new website and lead system has streamlined our entire sales process.',
                ...
                <div className="h-64 bg-gradient-to-br from-primary-100 to-primary-200 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-20 h-20 scale-[1.4] bg-primary-300 rounded-full flex items-center justify-center mx-auto mb-4">
                      <img className='w-full h-full object-cover rounded-full' src={project.image} alt="" />
                    </div>
                    <h3 className="text-xl font-semibold text-[#146aff]">{project.title}</h3>
                  </div>
                </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      {project.results.map((result) => (
                        <div key={result.metric} className="text-center">
                          <div className="text-2xl font-bold text-[#146aff]">{result.value}</div>
      ...
      <section className="stats-gradient text-white section-padding">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { icon: TrendingUp, metric: '285%', label: 'Average Traffic Increase' },
              { icon: Users, metric: '340%', label: 'Lead Generation Growth' },
              { icon: DollarSign, metric: '220%', label: 'Revenue Improvement' },
              { icon: ExternalLink, metric: '95%', label: 'Client Retention Rate' }
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
                initial={{ y: 20, opacity: 0 }}
